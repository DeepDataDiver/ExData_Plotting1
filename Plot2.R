...
#------------------------------------------------------------------------
# Task 2.2: Create Plot2 - Plot of Global_active_power by time of day
#------------------------------------------------------------------------
...
with(DT, plot(strptime(z, "%d/%m/%Y %H:%M:%S"), as.numeric(Global_active_power), type="l", xlab="", ylab="Global Active Power (kilowatts)"))
