...
#------------------------------------------------------------------------
# Task 2.1: Create Plot1 - Histogram of Global_active_power
#------------------------------------------------------------------------
...
with(DT, hist(as.numeric(Global_active_power), col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)"))
